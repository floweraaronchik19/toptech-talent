class InfiniteSlider {
	constructor(animTime = '50000', selector = '.slider-auto', container = '.ce-clients-wrapper-beta') {
	...
	animate() {
		...
		const sliderText = '<div class="row slider-extra position-relative" style="top: -2em" >' + this.container.innerHTML + '</div>'
		if ($(window).width() < 481) {
	...
	controlAnimation(timestamp) {
		...
		if (this._stop === true) {
			...
			const perc = ((timestamp - (this.start)) / this.duration) * 1220
...
document.addEventListener('DOMContentLoaded', function() {
	...
	slider.animate()
	// document.querySelector('.ce-clients-wrapper-beta')
